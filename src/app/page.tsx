...
export default function Home() {
  ...
  const features = [
    ...
    },
    {
      ...
      title: 'Find a professional assessor',
  ...
  const peopleQuotes = [{
    name: 'Omid Bidkham',
    img: '/person-1.webp',
    relation: { relation: 'expert', title: 'Flickit Group', href: 'https://flickit.org/expert-groups' },
  ...
  const QAs = [{ question: 'How does it work?', answer: 'It works like charm' },
  { question: 'How can i make new assessment in this platform?', answer: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus cum quidem amet consectetur adipisicing elit. Doloribus cum quidem eum harum necessitatibus, molestias deleniti, Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus cum quidem amet consectetur adipisicing elit. Doloribus cum quidem eum harum necessitatibus, molestias deleniti, Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus cum quidem amet consectetur adipisicing elit. Doloribus cum quidem eum harum necessitatibus, molestias deleniti,' },
  ...
  return (
    <main>
      ...
      <footer className='mt-36 p-8  mx-4'>
        <div className="mx-auto w-full max-w-screen-2xl p-4 py-6 lg:py-8">
          <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0">
              <a href="https://Flickit.org/" className="flex items-center">
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                ...
                <ul className="text-gray-600 dark:text-gray-400 font-medium">
                  <li className="mb-4">
                    <a href="https://Flickit.org/" className="hover:underline">Flickit</a>
                  </li>
                  <li>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://Flickit.org/" className="hover:underline">Flickit™</a>. All Rights Reserved.
            </span>
...
const Expandable = ({ question, answer }: { question: string, answer: string }) => {
  const [isExpanded, setIsExpand] = useState(false)
  const childRef = useRef<HTMLParagraphElement | null>(null)
  return <div className='bg-white text-black rounded-xl transition-all p-6 w-[calc(50%-34px)] duration-300 shadow-md hover:shadow-lg border border-gray-100 cursor-pointer mb-6' onClick={() => setIsExpand(!isExpanded)}>
    <div className='flex'>
      <Image src={isExpanded ? '/minus.svg' : '/plus.svg'} width={24} height={24} alt={'expand'} />
      <h6 className='text-lg font-bold ml-6'>{question}</h6>
    </div>
    <div className={`overflow-hidden duration-300 transition-all text-lg ml-12`} style={{ height: isExpanded ? `${childRef.current?.clientHeight}px` : '0px', marginTop: isExpanded ? `18px` : '0px' }}>
      <p ref={childRef} >
        {answer}
      </p>
